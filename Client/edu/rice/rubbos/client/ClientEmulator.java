...
public class ClientEmulator
{
  ...
  public static void main(String[] args)
  {
    ...
    { 
      ...
      System.out.println("<A HREF=\"trace_client0.csv\">Test trace (Download trace file logging response time for all page requests from all users!)</A><br>");
	...
	*/
        ...
        // Redirect output for traces, rewrite to a trace_client0.csv file
        PrintStream outputStream = new PrintStream(new FileOutputStream(reportDir+"trace_client0.csv"));
        System.setOut(outputStream);
        System.setErr(outputStream);
      }
      catch (IOException ioe)
    ...
    System.out.println("timestamp,userName,pageID,respTime");
